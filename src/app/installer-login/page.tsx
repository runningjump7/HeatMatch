    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Installer Portal</p>
        </div>
        ...
        <div className="bg-white py-8 px-6 shadow rounded-lg">
          ...
          <div className="mt-6 space-y-3">
            <Link href="/" className="text-center block text-sm text-blue-600 hover:text-blue-700">
              ← Back to site
            </Link>
            <p className="text-center text-sm text-gray-600">
              New? <Link href="/installer-signup" className="text-blue-600 hover:text-blue-700">Sign up here</Link>
            </p>
          </div>
        </div>
      </div>
