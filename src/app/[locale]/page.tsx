          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-sm font-semibold text-emerald-700 uppercase tracking-wide">{t('hero.badge')}</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-700">{t('hero.trustIndicators.freeService')}</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg width="24" height="24" viewBox="0 0 64 64" className="w-5 h-5 flex-shrink-0">
                  ...
                  <span className="text-sm text-gray-700">{t('hero.trustIndicators.noObligation')}</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg width="24" height="24" viewBox="0 0 64 64" className="w-5 h-5 flex-shrink-0">
                    <path d="M32 8l18 6v14c0 12-8 22-18 28-10-6-18-16-18-28V14z" fill="none" stroke="#10B981" strokeWidth="4"/>
                  </svg>
                  <span className="text-sm text-gray-700">{t('hero.trustIndicators.trustedInstallers')}</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg width="24" height="24" viewBox="0 0 64 64" className="w-5 h-5 flex-shrink-0">
                    <path d="M32 56s16-16 16-28a16 16 0 10-32 0c0 12 16 28 16 28z" fill="none" stroke="#10B981" strokeWidth="4"/>
                  ...
                  <span className="text-sm text-gray-700">{t('hero.trustIndicators.northShoreSpecialists')}</span>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
                ...
                {/* Form Title */}
                <h2 className="text-3xl font-bold text-gray-900 mb-6">{t('hero.formTitle')}</h2>
      ...
      <section id="how-it-works" className="py-16 md:py-24 bg-gray-50">
        <div className="px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            <span className="text-emerald-600 font-bold text-sm uppercase tracking-widest">{t('howItWorks.badge')}</span>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mt-3 mb-6 leading-tight">
              {t('howItWorks.heading')}
            </h2>
            <p className="text-lg text-gray-600">{t('howItWorks.subheading')}</p>
          </div>
          ...
          <div className="mb-16">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 mb-12">
              ...
              <div className="flex flex-col items-center flex-1 min-w-0">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 text-center">{t('howItWorks.step1Title')}</h3>
                <p className="text-gray-600 text-center text-sm">{t('howItWorks.step1Desc')}</p>
              </div>
              ...
              <div className="flex flex-col items-center flex-1 min-w-0">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 text-center">{t('howItWorks.step2Title')}</h3>
                <p className="text-gray-600 text-center text-sm">{t('howItWorks.step2Desc')}</p>
              </div>
              ...
              <div className="flex flex-col items-center flex-1 min-w-0">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2 text-center">{t('howItWorks.step3Title')}</h3>
                <p className="text-gray-600 text-center text-sm">{t('howItWorks.step3Desc')}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="coverage" className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <span className="text-emerald-600 font-bold text-sm uppercase tracking-widest">{t('coverage.badge')}</span>
          ...
          <div className="bg-gray-50 rounded-lg p-8 flex items-start gap-6">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-bold text-gray-900 mb-2">{t('coverage.expansion.title')}</h3>
              <p className="text-gray-600">{t('coverage.expansion.desc')}</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl p-8 md:p-12 border border-emerald-200">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-3">{t('trust.heading')}</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  t('trust.badges.qualityChecked'),
                  t('trust.badges.trustedBusinesses'),
                  t('trust.badges.fastResponse'),
                  t('trust.badges.satisfaction'),
                ].map((badge, idx) => (
